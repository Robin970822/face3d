...
import numpy as np
sys.path.append('../')
from face3d.render_utils.render import render
from face3d.render_utils.render.cython import mesh_core_cython
...
class RenderPipeline(object):
    ...
    def __call__(self, vertices, triangles, background):
        ...
        #     surface_normal = np.cross(v3 - v1, v2 - v1)
        ...
        # render_img = render.render_colors(vertices.T, triangles.T, color.T, height, width, BG=background)
